...
# torchcodec: required by torchaudio 2.5.1 for audio loading
# soundfile: fallback torchaudio backend
RUN pip install --no-cache-dir runpod requests huggingface_hub soundfile torchcodec
